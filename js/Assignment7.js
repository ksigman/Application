...
function sectionSelect(){
   ...
   case "section9":
      ...
      document.getElementById("section7").style.display = "none";
      document.getElementById("section8").style.display = "none";
      document.getElementById("section9").style.display = "inline-block";
      document.getElementById("section10").style.display = "none";
      break;
   case "section10":
      document.getElementById("section1").style.display = "none";
      ...
      document.getElementById("section8").style.display = "none";
      document.getElementById("section9").style.display = "none";
      document.getElementById("section10").style.display = "inline-block";
      break;
   default:
      return;
   }
...
function browserOpen(){
   cordova.InAppBrowser.open('http://uab.edu', '_blank', 'location=yes');
}